...
class PopularTvDetailsComponent extends StatelessWidget {
  const PopularTvDetailsComponent({Key? key}) : super(key: key);
        ...
        case RequestState.loaded:
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              List dateOfRelease = state.popularTv[index].firstAirDate.split('-');
              return Padding(
                        ...
                        Container(
                          ...
                          child: CachedNetworkImage(
                            ...
                            imageUrl: state.popularTv[index].backdropPath != null
                                ...
                                state.popularTv[index].backdropPath!)
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  '${state.popularTv[index].voteAverage}',
                                  style: GoogleFonts.poppins(
                                      fontSize: 12,
                                      letterSpacing: 0.15,
                                      color: Colors.white),
                            ...
                            Container(
                              ...
                              child: Text(
                                state.popularTv[index].overView,
