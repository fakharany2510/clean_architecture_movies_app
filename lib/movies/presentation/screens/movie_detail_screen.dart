...
class MovieDetailContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
      ...
      print('state is ${state.recommendation.length}');
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: Text(
                                state.moveDetail!.releaseDate.split('-')[0],
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  (state.moveDetail!.voteAverage / 2)
                                      .toStringAsFixed(1),
                                  style: const TextStyle(
                                    fontSize: 16.0,
                                    fontWeight: FontWeight.w500,
                            ...
                            const SizedBox(width: 16.0),
                            Text(
                              _showDuration(state.moveDetail!.runtime),
                              style: const TextStyle(
                        ...
                        const SizedBox(height: 8.0),
                        Text(
                          'Genres: ${_showGenres(state.moveDetail!.genres)}',
                          style: const TextStyle(
                            color: Colors.white70,
                            fontSize: 12.0,
                            fontWeight: FontWeight.w500,
                  ...
                  delegate: SliverChildBuilderDelegate(
                      ...
                      return FadeInUp(
                        ...
                        child: ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            imageUrl:
                            ApiConstance.imageUrl(state.recommendation[index].backdropPath!),
  ...
  Widget _showRecommendations() {
    return BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
      builder: (context, state) {
        print('this is the state of the recommendation ${state}');
        return SliverGrid(
          delegate: SliverChildBuilderDelegate(
                (context, index) {
